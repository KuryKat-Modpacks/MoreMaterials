...
public enum MoreMaterialsBlockTags {
    ;

    public final TagKey<Block> tag;
    public final boolean alwaysDataGen;

    MoreMaterialsBlockTags() {
        this(MOD);
    }

    MoreMaterialsBlockTags(Namespace namespace) {
        this(namespace, namespace.optionalByDefault, namespace.alwaysDataGenByDefault);
    }

    MoreMaterialsBlockTags(Namespace namespace, String path) {
        this(namespace, path, namespace.optionalByDefault, namespace.alwaysDataGenByDefault);
    }

    MoreMaterialsBlockTags(Namespace namespace, boolean optional, boolean alwaysDataGen) {
        this(namespace, null, optional, alwaysDataGen);
    }

    MoreMaterialsBlockTags(Namespace namespace, String path, boolean optional, boolean alwaysDataGen) {
